...
function Services() {
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-hidden">
      <Helmet>
        <title>
          ESG Impact Investing - Consulting for Investors | Rho Impact
        </title>
        <meta charset="UTF-8" />
        <meta
          name="description"
            ...
            <div className="py-12 md:py-20">
              ...
              <div className="max-w-3xl mx-auto text-center mt-16 pb-12">
                ...
                <p className="text-xl text-slate-768">
                  Environmental, social, and governance issues present risks and
                  opportunities to your investment portfolio. Whether you’re an
                  institutional investor, family office, venture capital or
                  private equity group, the ESG performance of your portfolio
                  companies will directly impact your financial returns and
                  social license to operate. Rho Impact supports a wide-range of
                  investors in translating their ESG and impact aspirations into
                  action and results.
                </p>
                <br />
                <p className="text-xl text-slate-768">
              ...
              <div className="max-w-sm md:max-w-2xl xl:max-w-6xl mx-auto grid gap-8 md:grid-cols-2 xl:grid-cols-3 xl:gap-4 items-start">
                ...
                >
                  <div className="mb-4">
                    ...
                    The Rho Impact “ESG-as-a-Service” provides the ESG advisory, software, and hands-on support to help you adapt and thrive in the new normal of business.
                    </div>
                    <br/>
                  </div>
                ...
                >
                  <div className="mb-4">
                    ...
                    <div className="text-lg text-gray-800">
                    Portfolio ESG integration can be complex, confusing, and labor intensive. That’s why we provide customized solutions for key pain points in the ESG integration and implementation process.
                    </div>
                    <br />
                  </div>
                  <div className="border-t border-gray-200 pt-5 mt-6">
                    <Link
                      className="btn-sm text-white bg-blue-600 hover:bg-blue-700 w-full"
                      to="/esg-special-projects/investor/"
                    >
                      Learn More
                    </Link>
                  </div>
                ...
                >
                  <div className="mb-4">
                    ...
                    <div className="text-lg text-gray-800">
                    Rho Impact provides a systematic approach for measuring and managing your impact performance today, and projecting what these impacts will be in the future.
                    </div>
                    <br />
                  </div>
                  <div className="border-t border-gray-200 pt-5 mt-6">
                    <Link
                      className="btn-sm text-white bg-blue-600 hover:bg-blue-700 w-full"
                      to="/portfolio-potential-impact-analysis/"
                    >
                      Learn More
                    </Link>
                  </div>
