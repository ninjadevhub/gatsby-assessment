            ...
            <div className="py-12 md:py-20">
              ...
              <div className="max-w-3xl mx-auto text-center mt-16 pb-12">
                ...
                <p className="text-xl text-slate-768">
                  Adapt to your client’s ESG expectations and deliver results
                  with support from Rho Impact’s advisory team and software
                  suite. Round out your service offerings, address a broader
                  range of issues, and stay relevant to your clients in ‘the age
                  of ESG.’
                </p>
              </div>
              ...
              <div className="max-w-3xl mx-auto bg-white p-12">
                <ul className="text-gray-600 -mb-2 flex-grow">
                  <li className="flex items-center mb-2">
                    ...
                    <span>
                      Develop and implement your firm's internal ESG strategy,
                  ...
                  <li className="flex items-center mb-2">
                    ...
                    <span>
                      Address the immediate pain points of your clients,
                      accelerated by Rho Impact’s services and software products
                    </span>
                  </li>
                  <li className="flex items-center mb-2">
                    <svg
                    ...
                    <span>
                      Establish an ESG practice and business development
                      strategy
                    </span>
                  </li>
                </ul>
                ...
                <div className="mt-32 mx-auto">
                  <Link
                    to="/esg-as-service/"
                    className="inline-flex items-center text-base text-blue-500 font-medium hover:underline"
                  >
                    <svg
