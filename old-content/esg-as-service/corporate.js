...
function Services() {
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-hidden">
      <Helmet>
        <title>
          ESG as a Service | ESG Consulting for Corporations | Rho Impact
        </title>
        <meta charset="UTF-8" />
        <meta
          name="description"
            ...
            <div className="py-12 md:py-20">
              ...
              <div className="max-w-3xl mx-auto text-center mt-16 pb-12">
                ...
                <p className="text-xl text-slate-768">
                  ESG has become the ultimate litmus test for management
                  effectiveness in the new normal. Addressing the range of
                  issues, expectations, and reporting frameworks requires an
                  experienced, multidisciplinary team. The Rho Impact
                  “ESG-as-a-Service” combines ESG advisory, software, and
                  hands-on implementation support. We function as your
              ...
              <div className="max-w-3xl mx-auto bg-white p-12">
                <ul className="text-gray-600 -mb-2 flex-grow">
                  <li className="flex items-center mb-2">
                    ...
                    <span>
                      Address immediate pressures and stakeholder expectations
                    </span>
                  </li>
                  <li className="flex items-center mb-2">
                    <svg
                    ...
                    <span>
                      Implement ESG planning, tracking, and reporting best
                      practices
                    </span>
                  </li>
                  <li className="flex items-center mb-2">
                    ...
                    <span>
                      Create the internal governance and capabilities needed for
