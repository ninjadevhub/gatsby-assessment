...
function CTAGeneric({ title, paragraph, ctaText, url, bgClass = 'bg-slate-100', includeFlourish = true }) {
  return (
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="relative max-w-3xl mx-auto text-center">
            ...
            <div className="relative">
              <h2 className="h2 font-playfair-display text-slate-800 mb-4">{title}</h2>
              <p className="text-xl text-slate-500 mb-8">{paragraph}</p>
              <div>
                <Link className="btn text-white bg-blue-500 hover:bg-blue-600 group" to={url}>
                  {ctaText}
                </Link>
              </div>
            </div>
