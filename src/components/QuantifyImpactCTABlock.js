...
function QuantifyImpactCTABlock() {
  return (
        ...
        <div className="pt-28 md:pt-40">
          ...
          <div className="max-w-3xl mx-auto text-center pb-6 md:pb-10">
            <h2 className="h2 font-playfair-display text-slate-800 mb-4">
              Leverage our data and team to <span className="text-emerald-500">
                identify and communicate impact mechanisms
              </span> unique to your business.
            </h2>
          </div>
        </div>
      </div>
          ...
          <div className="relative max-w-sm mx-auto grid gap-6 md:grid-cols-1 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-4 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                Get started in minutes with a self-guided assessment to prepare us for a short discovery call.
              </p>
              <br />
              <a
            ...
            <div className="relative flex flex-col items-center p-4 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1 text-center">
                Functional Impact Model
              </h4>
              <p className="text-gray-600 text-center">
                Get an impact model in 2-4 weeks that quantifies and forecasts
                your impact. Auditable by design and built with integrity.
              </p>
              <br />
              <Link
...
export default QuantifyImpactCTABlock;
