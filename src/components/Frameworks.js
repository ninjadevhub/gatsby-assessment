    ...
    return (
      <section>
        <div className="max-w-6xl px-4 mx-auto sm:px-6">
          <div className="py-12 md:py-18 md:pb-20">
            {/* Items */}
            <div className="grid items-start max-w-sm gap-12 mx-auto md:grid-cols-3 md:-mx-9 md:gap-0 md:max-w-none">
              ...
              >
                ...
                <h4 className="mb-1 text-xl font-bold">Carbon Footprint Calculation</h4>
                <p className="text-slate-500">
                Calculate the carbon footprint of your organization by assessing greenhouse gas emissions across various operational activities.
                </p>
              </div>
              ...
              >
                ...
                <h4 className="mb-1 text-xl font-bold">Sustainability Reporting</h4>
                <p className="text-slate-500">
                Get help in preparing sustainability reports that provide information on ESG metrics, including social and environmental impact, governance practices, and financial performance.
                </p>
              </div>
              ...
              >
                ...
                <h4 className="mb-1 text-xl font-bold">Environmental, Social, and Governance (ESG) Frameworks</h4>
                <p className="text-slate-500">
                Assistance in selecting and implementing relevant ESG frameworks, including GRI, CDP, and SASB, to ensure that your organization is reporting on the most material ESG issues and adhering to industry best practices.
                </p>
              </div>
            </div>
          </div>
